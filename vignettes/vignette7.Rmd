...
```{r specord, cache = TRUE, fig.width=7}
...
The red lines indicate 10, 15, and 20 neighbours. Clearly, ordering the species by their sum of squared distances, or by the first eigenvector of the phylogenetic covariance matrix, gives the best approximation here (i.e., most accurate with least neighbouts) for this dataset.
