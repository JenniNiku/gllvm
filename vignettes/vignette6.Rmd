...
```{r eval=FALSE}
MGLM <- gllvm(Y,X=X,family=family)
```
...
```{r eval=FALSE}
RRGLM <- gllvm(Y,X=X,family=family, num.RR=2)
```
...
```{r eval=FALSE}
CGLLVM <- gllvm(Y,X=X,family=family, num.lv.c = 2, n.init=10)
```
