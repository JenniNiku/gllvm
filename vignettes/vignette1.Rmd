...
|             | ZIB     |    VA/EVA/LA   |logit   | 
|zero/N-inflated|ZNIB    |VA/LA           |probit/logit/cloglog| $E(y_{ij}) = p_j^N N_j + (1-p^0_j-p_j^N)N_j\mu_{ij}$, $V(\mu_{ij}) = p_j^N N_j^2 + (1-p_j^0-p^{N_j}) N_j\mu_{ij} (1-\mu_{ij}+N_j\mu_{ij})-E[Y_{ij}]^2$|
...
|Percent cover with zeros/ones| ordered beta    	   | VA-EVA/EVA | probit/logit | details in Korhonen et al (2024) |
