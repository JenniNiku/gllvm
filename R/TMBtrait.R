...
trait.TMB <- function(
      ...
      link="logit",n.init=1,n.init.max = n.init + 10, start.params=NULL,start0=FALSE,optimizer="optim", dr=NULL, rstruc =0, cstruc = "diag", dist = matrix(0),  scalmax=10, MaternKappa = 1.5,
