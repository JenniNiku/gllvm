  ...
  while(n.i <= n.init){
    ...
    if(!is.null(randomX)){
      ...
      if(!is.null(colMat) && all(dim(colMat)!=1)){
        ...
        blocks <- append(list(matrix(p,nrow=1,ncol=1)), blocks)
