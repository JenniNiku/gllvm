    ...
    if (!biplot) {
      ...
      if (predict.region %in% c(TRUE, "sites")) {
        ...
        if (object$method == "LA") {
          ...
          } else if((object$num.lvcor > 1) && (object$Lambda.struc %in% c("diag_unstructured","NN_unstructured","unstructured_unstructured"))) { #Not used at the moment, under development
