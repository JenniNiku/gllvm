...
start_values_gllvm_TMB <- function(y, X = NULL, lv.X = NULL, TR=NULL, xr = matrix(0), dr = matrix(0), csR = matrix(0), proptoMats = list(list(matrix(0))), trmsize = matrix(0), cstruc = NULL, family,
