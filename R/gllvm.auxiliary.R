  ...
  if(num.lv.c>0&num.lv==0){
    if(p>2 && n>2){
      ...
      if(any(family %in% c("binomial","beta","betaH","orderedBeta","ZIB", "ZNIB"))) {
        mu[, family %in% c("binomial","beta","betaH","orderedBeta","ZIB", "ZNIB", "beta.binomial")] <-  binomial(link = link)$linkinv(eta[,family %in% c("binomial","beta","betaH","orderedBeta","ZIB", "ZNIB", "beta.binomial")])
      }
