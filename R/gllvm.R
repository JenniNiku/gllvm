...
#'   \item{\emph{n.init.max}: }{ maxmimum number of refits try try for n.init without improvement. Defaults to 1 if n.init is 1, and n.init + 10 otherwise.}
...
gllvm <- function(y = NULL, X = NULL, TR = NULL, data = NULL, formula = NULL, family,
                  ...
                  control.start = list(starting.val = "res", n.init = 1, n.init.max = 1, jitter.var = 0, start.fit = NULL, start.lvs = NULL, randomX.start = "zero", quad.start=0.01, start.struc = "LV", scalmax = 10, MaternKappa=1.5), setMap=NULL, ...
                  ) {
  # Dthreshold=0,
