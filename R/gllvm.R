...
#'@importFrom graphics abline axis par plot segments text points boxplot barplot panel.smooth lines polygon arrows 
...
gllvm <- function(y = NULL, X = NULL, TR = NULL, data = NULL, formula = NULL, family,
                  ...
                  control.start = list(starting.val = "res", n.init = 1, n.init.max = 10, jitter.var = 0, jitter.var.br = 0, start.fit = NULL, start.lvs = NULL, randomX.start = "res", quad.start=0.01, start.struc = "LV", scalmax = 10, MaternKappa=1.5, rangeP=NULL), setMap=NULL, ...
                  ) {
  # Dthreshold=0,
...
# Structured row parameters
    ...
    if(inherits(lvCor,"formula")) {
      ...
      num.lv.cor = num.lv
      if(cstruclv == "corAR1") dist = matrix(1:ncol(dLV))
