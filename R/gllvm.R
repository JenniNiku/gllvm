...
gllvm <- function(y = NULL, X = NULL, TR = NULL, data = NULL, formula = NULL,
                  ...
                  randomX = NULL, randomX.start = "res", dependent.row = TRUE, beta0com = FALSE) {
